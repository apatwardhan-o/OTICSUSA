...
def extract_metadata_from_path(full_path):
    """
    Extracts file-level metadata and operating system file creation date.
    """
    path_up = full_path.upper()
    
    # Get File Creation Date from OS
    try:
...
def main():
    ...
    # Column ordering to match SQL (ensure FileCreatedAt is included)
    sql_cols = [
